...
class CA_SUM(nn.Module):
    ...
    def forward(self, frame_features, mask_attn=False, fragments=None) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        weighted_value, attn_weights = self.attention(frame_features, mask_attn, fragments)
